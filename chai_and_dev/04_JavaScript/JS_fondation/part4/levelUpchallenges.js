...
// forin loop -> is for objects in this order is not imp, any element can be accessed first
// forof loop -> is for arrray in this order is imp and eleents are accessed by indexing
...
// console.log(Object.keys(citiesPopulation)) to get all the keys of the object
// console.log(Object.values(citiesPopulation)) to get all the values of the object
...
`["Berlin", "Tokyo", "Sydney", "Paris"]`. Skip `"Sydney"` 
and store the other cities in a new array named `traveledCities`.
*/
...
9. Write a `for` loop that iterates through the array `[2, 5, 7, 9]`. 
   ...
   in a new array named `doubledNumbers`.
*/
