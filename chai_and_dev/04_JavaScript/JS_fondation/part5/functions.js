...
// greet("Shantanu") example of function
...
let orderConfirmation = orderTea("oolang tea")
...
function, `makeTea`, as a parameter and calls it with the argument `"earl grey"`. 
...
like `"Making green tea"`. Store the returned function in a 
variable named `teaMaker` and call it with `"green tea"`.
*/

function createTeaMaker(name) {
  let price = 100
  return function (teaType) {
    return `Making ${teaType} for ${name} at ${price}`
  }
}

let teaMaker = createTeaMaker("Shan")
